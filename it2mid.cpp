...
int main(int argc, char* argv[])
{
	...
	if (argc <= 2)
	{
		printf("Uso: it2mid.exe <archivo it> <archivo de salida mid>.\n");
		printf("Se recomienda que el archivo .it este en la misma carpeta que el exe, pero deberia dar igual Kappa.\n");
		return 0;
	}
	...
	if (hFile == NULL)
	{
		printf("F. Error leyendo archivos\n");
		return 1;
	}
